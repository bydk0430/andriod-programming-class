...
public class MainActivity extends AppCompatActivity {
    ...
    Button button_play, button_stop;//  버튼 객체를 위한변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  서비스와 통신을 위해 리시버를 등록
        registerReceiver(receiver, new IntentFilter("com.example.student.mp3playerservice"));
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(state != null) { // state라는 키에 맞는 값이 있다
                ...
                if(state.equals("play")) {
                    ...
                    //  서비스가 중지 혹은 일시 중지 명령을 수행한 결과가 있다면

                    //  재생 중임을 표시하는 bStatePlay 변수에 false 저장
                    bStatePlay =false;
    ...
    class myButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent = new Intent("com.example.student.mp3playerservice");
            switch (v.getId()) {
                //  play & pause 버튼
